  ...
  asyncHandler(async (req, res) => {
    try {
      const products = await Product.findAll({
        include: [
          {
            model: Category, // Модель для `proCategoryId`
            as: "proCategory", // Имя ассоциации
            attributes: ["id", "name"], // Выбор полей
          },
          {
            model: SubCategory, // Модель для `proSubCategoryId`
            as: "proSubCategory", // Имя ассоциации
            attributes: ["id", "name"], // Выбор полей
          },
          {
            model: Brand, // Модель для `proBrandId`
            as: "proBrand", // Имя ассоциации
            attributes: ["id", "name"], // Выбор полей
          },
          {
            model: VariantType, // Модель для `proVariantTypeId`
            as: "proVariantType", // Имя ассоциации
            attributes: ["id", "type"], // Выбор полей
          },
          {
            model: Variant, // Модель для `proVariantId`
            as: "proVariant", // Имя ассоциации
            attributes: ["id", "name"], // Выбор полей
          },
        ],
      });
